...
q.Size=UDim2.new(1,0,0,o.Type=="Input"and 20 or 40)
...
local function CreateDropdownGroup(data)
    local self = {
        __type = "Group",
    ...
    local GroupFrame = Framework.New("Frame", {
    ...
    local ToggleButton = Framework.New("TextButton", {
        Text = "▶ " .. self.Title,
        TextSize = 16,
    ...
    local Container = Framework.New("Frame", {
        BackgroundTransparency = 1,
        Size = UDim2.new(1, 0, 0, 0),
        AutomaticSize = Enum.AutomaticSize.Y,
        Visible = false,
    ...
    ToggleButton.MouseButton1Click:Connect(function()
        ...
        Container.Visible = self.IsOpen
        ToggleButton.Text = (self.IsOpen and "▼ " or "▶ ") .. self.Title
    end)

    self.Container = Container
    self.Frame = GroupFrame
    return self
end
